...
function Home() {
  return (
    <div className='w-full min-h-screen text-3xl'>
        <div className=" text-white pt-36 lg:pt-24 lg:pb-56 pb-72 w-full">
          ...
          <p className='pt-12 lg:pt-28 text-center text-xl lg:text-2xl' data-aos="fade-up" data-aos-delay="1000">A Platform where <span className="font-bold italic">Diplomacy</span> meets <span className="font-bold italic">Education</span></p>
        </div>
