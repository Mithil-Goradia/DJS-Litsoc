...
const DJMUN24 = () => {
  const cardsInfo = [
    {title: "OPEC: Political Club vs. Economic Cartel", content: "Assessing the global oil market implications when member nations prioritize leveraging OPEC as a platform for geopolitical influence over its economic functions."},
    {title: "UNSC: The Nagorno-Karabakh Conflict", content: "Addressing the historical claims, influence of regional powers and their strategic interests and the efficacy of international ceasefire agreements."},
    {title: "LOK SABHA: Reservation: A Baggage carried too far?", content: "Debating on caste-based reservations, the extension of reservations to economically weaker sections (EWS), and the implications of these policies on social justice."},
    {title: "UNCSW: Where are the Women Leaders?", content: "Discussing the lack of women representation in political leadership with a special emphasis on the MENA region."},
    {title: "Continuous Crisis Committee", content: ""},
    {title: "International Press (IP)", content: ""}
  ];
  return (
    <>
      <div 
...
const Card = ({ title, content }) => (
  <div className="border-solid border-2 border-white text-white lg:p-6 p-4 rounded-xl shadow-md w-full mb-6 flex-row lg:flex justify-center items-center lg:gap-5">
    <div className="lg:hidden w-full lg:w-1/4 ml-[90px] lg:ml-0">
      <div className='w-28 h-28 lg:w-36 lg:h-36 bg-gray-300 rounded-full lg:mx-4'></div>
    </div>
