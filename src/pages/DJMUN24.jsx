...
const DJMUN24 = () => {
  ...
  return (
    <>
      ...
      >
        <div className='text-center text-5xl lg:text-[120px] font-bold font-Quicksand lg:pb-8 pb-12' data-aos="fade-down" data-aos-delay="300">DJSMUN'24</div>
        <div className="w-full lg:px-44 px-[14px] text-xl text-center pb-10" data-aos="fade-down" data-aos-delay="300">
        ...
        <div className="w-full flex justify-center" data-aos="fade-up" data-aos-delay="500">
          <a 
            // data-aos="fade-up" 
            // data-aos-delay="1300"
        ...
        <div className='w-full flex justify-center'>
          <div className="w-full p-4 pt-20">
            <h1 className="text-5xl font-bold text-center text-white mb-12" data-aos="fade-in" data-aos-delay="300">COMMITTEES</h1>
